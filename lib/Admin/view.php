...
<body data-phone-cc-input="1">
  ...
  <div class="row">
      <div class="col-md-12" style="margin:15px;">
          ...
          <form name="review" onSubmit="return checkFormMessage(this);" action="addonmodules.php?module=my_referral&action=submit" method="post">
              <input type="hidden" name="mode" value="sendmessage">
              <input type="hidden" name="reviewer_id" value="0">
              <input type="hidden" name="admin_id" value="<?php echo $reviewer_id; ?>">
              ...
              <table class="form" width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                   ...
                   <tr>
                        <td class="fieldlabel text-left" ></td>
                        <td class="fieldlabel text-left" ></td>
                        <td class="fieldarea text-left"><?php echo $LANG['no_review_msgs']; ?></td>
                   		<td class="fieldlabel text-left" ></td>
                   </tr>
                   <?php endif; ?>   
                    <tr>
                        <td class="fieldlabel text-left" ></td>
                        <td class="fieldlabel text-left"  width="18%" ><?php echo $LANG['review_msg']; ?>:</td>
                        <td class="fieldarea text-left" >
